# Amphibrachic tetrameter checker
...
Opening lines scan cleanly as amphibrachic tetrameter; later lines loosen for speech and song.

### The Old Oaken Bucket — Samuel Woodworth

How dear to my heart are the scenes of my childhood

Early nineteenth-century narrative lyric often cited for English amphibrachic tetrameter.
...
Contemporary formal poem built on amphibrachic tetrameter with mixed masculine and feminine endings.

## How amphibrachic tetrameter works
...
Yes. Use Continue in the editor with Amphibrachic tetrameter — if you edited the checker (not just the stock sample), that text carries into the editor once. Nothing is uploaded.

## Open the editor

Continue in the editor: https://lyriic.com/

Open with Amphibrachic tetrameter meter: https://lyriic.com/write/amphibrachic-tetrameter
