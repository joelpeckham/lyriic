...
The landmark non-dramatic blank-verse epic; Milton defends unrhymed pentameter in a prefatory note.

### Hamlet (soliloquies) — William Shakespeare

To be, or not to be, that is the question…

Much of Shakespeare’s dialogue is blank verse; feminine endings (an extra weak syllable) are common.

### Ulysses — Alfred, Lord Tennyson

To strive, to seek, to find, and not to yield.

Victorian dramatic monologue in sustained blank verse.

### Mending Wall — Robert Frost

Something there is that doesn’t love a wall…

Modern conversational blank verse; stress bends toward speech.

## How blank verse works
...
Open with Blank verse meter: https://lyriic.com/write/blank-verse
