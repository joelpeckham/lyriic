...
Foundational Greek epic in quantitative dactylic hexameter; English translations rarely preserve the original meter.

### Odyssey — Homer

Companion Homeric epic composed in the same hexameter tradition.

### Aeneid — Virgil

Arma virumque canō, Troiae quī prīmus ab ōrīs

Latin epic hexameter; the opening arma virumque canō is a standard classroom scansion example.

### Evangeline — Henry Wadsworth Longfellow

This is the forest primeval. The murmuring pines and the hemlocks,

Best-known extended English poem in unrhymed dactylic hexameter; lines mix dactyls with shorter final feet.
...
Yes. Use Continue in the editor with Dactylic hexameter — if you edited the checker (not just the stock sample), that text carries into the editor once. Nothing is uploaded.

## Open the editor

Continue in the editor: https://lyriic.com/

Open with Dactylic hexameter meter: https://lyriic.com/write/dactylic-hexameter
