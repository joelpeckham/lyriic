...
Unlike haiku or the sonnet, the etheree has no fixed literary canon of widely anthologized poems. It lives mainly in workshops, online form guides, and contemporary practice pieces.

### Wouldn’t Chu? — Lawrencealot

Duck / Pigeon / Meadow lark / Ring-neck pheasant / swallow, sparrow, hawk…

Often cited on poetry-form sites as a clear 1–10 teaching example (bird names expanding into flight).

### Pain — Attributed (PoetrySoup / form guides)

Pain / Pain, / My friend, / You give me / Many lessons…

A frequently reprinted sample etheree in online dictionaries of the form; useful for seeing how a single opening word widens across the ladder.

## How the etheree works
...
### Does lyriic include an etheree meter ruler?
...
Open with Etheree meter: https://lyriic.com/write/etheree
