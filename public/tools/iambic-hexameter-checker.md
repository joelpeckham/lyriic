...
Each Spenserian stanza ends with a ninth-line alexandrine (iambic hexameter) after eight pentameters.

### Poly-Olbion — Michael Drayton

Ye sacred Bards, that to your harps' melodious strings

A long topographical poem written throughout in English alexandrines.

### An Essay on Criticism — Alexander Pope

That, like a wounded snake, drags its slow length along.

Famous parody of the alexandrine’s “slow length” in a heroic-couplet context.

### Fifine at the Fair — Robert Browning

A late Victorian dramatic poem composed largely in English alexandrines.

## How iambic hexameter works
...
Yes. Use Continue in the editor with Iambic hexameter — if you edited the checker (not just the stock sample), that text carries into the editor once. Nothing is uploaded.

## Open the editor

Continue in the editor: https://lyriic.com/

Open with Iambic hexameter meter: https://lyriic.com/write/iambic-hexameter
