...
Opening line is a classroom staple; the first foot is often scanned as a trochaic inversion.

### Hamlet (Act 3, Scene 1) — William Shakespeare

To be, or not to be, that is the question

Blank verse: unrhymed iambic pentameter; the famous line ends with a feminine eleventh syllable.

### Paradise Lost — John Milton

Of Man’s first disobedience, and the fruit

Epic blank verse built on iambic pentameter with frequent metrical variation.

### The Prelude — William Wordsworth

Oh there is blessing in this gentle breeze

Autobiographical blank verse in iambic pentameter.
