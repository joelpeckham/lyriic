...
Opening line is a clean teaching example of four iambs.

### Stopping by Woods on a Snowy Evening — Robert Frost

Whose woods these are I think I know.

Sustained iambic tetrameter with a tight AABA rhyme scheme lyriic does not check.

### I Wandered Lonely as a Cloud — William Wordsworth

I wandered lonely as a cloud

Daffodil lyric often cited for tetrameter; some lines admit light substitutions.

### The Lady of Shalott — Alfred, Lord Tennyson

On either side the river lie

Narrative stanzas lean heavily on iambic tetrameter lines.
...
Yes. Use Continue in the editor with Iambic tetrameter — if you edited the checker (not just the stock sample), that text carries into the editor once. Nothing is uploaded.

## Open the editor

Continue in the editor: https://lyriic.com/

Open with Iambic tetrameter meter: https://lyriic.com/write/iambic-tetrameter
