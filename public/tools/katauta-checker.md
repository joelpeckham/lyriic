...
### Man’yōshū I:20 (opening katauta) — Princess Nukata (Nukata no Ōkimi)

You ride purple fields / marked as imperial domain — / these murasaki grasses.

Opening half of a celebrated sedōka: purple fields, imperial hunting grounds, and a secret sleeve-wave. English syllable counts vary widely by translation.

### Untitled katauta — Robert Lee Brewer

why do winter stars / shine brighter than summer stars / as if they are shards of glass?

A contemporary English teaching example (Writer’s Digest) cast as a lover’s question in 5-7-7.

### Kojiki / Nihon Shoki short songs — Anonymous (early chronicles)

Arthur Waley and others note that a few of the shortest poems in the early chronicles already take a 5-7-7 shape — ancestors of later katauta counting practice.
...
Open with Katauta meter: https://lyriic.com/write/katauta
