...
### Nature — Robert Lee Brewer

There's a life curled in the darkness / sweating out the evening storm / beneath leaves covered with rain / …

Writer’s Digest teaching nonet illustrating the 9→1 countdown; a craft example, not a canonical anthology piece.

### Midnight's Breath — Shadow Poetry community example

Frequently cited on form-reference sites; typical of how nonets circulate in online workshops rather than major anthologies.

### Canonical nonets

The form has no widely agreed canon of famous poems. Contests and teaching samples dominate; treat “famous” examples as illustrative, not authoritative.
...
Yes. Use Continue in the editor with Nonet — if you edited the checker (not just the stock sample), that text carries into the editor once. Nothing is uploaded.
