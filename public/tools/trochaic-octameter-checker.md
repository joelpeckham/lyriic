...
Classroom staple for trochaic octameter; stanzas mix full sixteen-syllable lines with shorter catalectic refrain lines.

### Locksley Hall — Alfred, Lord Tennyson

Comrades, leave me here a little, while as yet ’tis early morn:

Long trochaic narrative lines, typically catalectic (ending on a strong beat).

### Mandalay — Rudyard Kipling

By the old Moulmein Pagoda, lookin’ eastward to the sea,

Ballad-like long trochaic lines with a refrain; often scanned with catalectic endings.

### Clancy of the Overflow — Banjo Paterson

I had written him a letter which I had, for want of better

Australian bush ballad built on four long trochaic octameter lines per stanza.

## Trochaic octameter (16)
...
Yes. Use Continue in the editor with Trochaic octameter — if you edited the checker (not just the stock sample), that text carries into the editor once. Nothing is uploaded.

## Open the editor

Continue in the editor: https://lyriic.com/

Open with Trochaic octameter meter: https://lyriic.com/write/trochaic-octameter
