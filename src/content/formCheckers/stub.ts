  ...
  return {
    ...
    faqs: [
      ...
      },
      {
        ...
        plain: `Yes. Continue in the editor with ${entry.label} for live rulers beside each line. Edited checker text can carry over once; nothing is uploaded.`,
        href: writerPath(entry.id),
